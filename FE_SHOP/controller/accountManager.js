...
function fetchUsers(page) {
    fetch(`http://192.168.172.130:8080/admin/users/listusers?page=${page}`,{
        method: 'GET',
        headers: {
...
function add() {
    ...
    fetch('http://192.168.172.130:8080/admin/users/adduser', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json'
...
function deleteRow(id) {
    if (confirm("Bạn có chắc chắn muốn xóa người dùng này không?")) {
        ...
        fetch(`http://192.168.172.130:8080/admin/users/delete/${id}`, {
            method: 'DELETE',
            headers: {
                'Authorization': 'Bearer ' + token,
                'Content-Type': 'application/json'
...
function updateUser() {
    ...
    fetch(`http://192.168.172.130:8080/admin/users/update/${userId}`, {
        method: 'PUT',
        headers: {
            'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json'
...
function searchByUsername() {
    ...
    fetch(`http://192.168.172.130:8080/admin/users/search?keyword=${searchInput}`,
        {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + token,
