...
function addFeedback() {
    ...
    fetch('http://localhost:8080/api-feedback/add_feedback', {
        method: 'POST',
        headers: {
...
function deleteFeedback(id) {
  ...
  fetch(`http://localhost:8080/api-feedback/delete/${id}`, {
        method: 'DELETE',
    })
        .then(response => {
            if (!response.ok) {
...
function updateFeedback() {
    ...
    const newfeedback = {
        ...
        fetch(`http://localhost:8080/api-feedback/update_feedback/${feedbackid}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
function searchFeedback() {
    ...
    fetch(`http://localhost:8080/api-feedback/search?keyword=${searchInput}`,
        {
            method: 'GET',
            headers: {
